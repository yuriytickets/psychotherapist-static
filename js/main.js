...
function themeOption(){
    ...
    $('#submit-btn').on('click', function(e) {
      var formValidated = sendEmailValidate();
      if(!formValidated) {
        e.preventDefault();
      }
    });
...
function sendEmailValidate() {
    ...
    if(!name){
        ...
        $('.toast-body').html('ÐÐµÐ¾Ð±Ñ…Ñ–Ð´Ð½Ð¾ Ð²Ð²ÐµÑÑ‚Ð¸ Ñ–Ð¼\'Ñ');
        return false;
    } else if(!email){
        $('#message').toast('show').addClass('bg-danger').removeClass('bg-success');
        $('.toast-body').html('Ð¿Ð¾Ð»Ðµ Email Ð½Ðµ Ð·Ð°Ð¿Ð¾Ð²Ð½ÐµÐ½Ð¾');
        return false;
    } else if(!validateEmail(email)){
        $('#message').toast('show').addClass('bg-danger').removeClass('bg-success');
        $('.toast-body').html('Email Ð½ÐµÐ²Ð°Ð»Ñ–Ð´Ð½Ð¸Ð¹');
        return false;
    } else if(!subject){
        $('#message').toast('show').addClass('bg-danger').removeClass('bg-success');
        $('.toast-body').html('Ð¢ÐµÐ¼Ð° Ð¾Ð±Ð¾Ð²\'ÑÐ·ÐºÐ¾Ð²Ð° Ð´Ð¾ Ð·Ð°Ð¿Ð¾Ð²Ð½ÐµÐ½Ð½Ñ');
        return false;
    }else if(!comments){
        $('#message').toast('show').addClass('bg-danger').removeClass('bg-success');
        $('.toast-body').html('Ð’Ð²ÐµÐ´Ñ–Ñ‚ÑŒ Ð¿Ð¾Ð²Ñ–Ð´Ð¾Ð¼Ð»ÐµÐ½Ð½Ñ');
        return false;
    }else {
        return true;
    }
...
//# sourceMappingURL=application.js-56b732d71bd1a09a7b321362d3befad25bfcde0b0664e6c8246b0a7a1f94a348.map
